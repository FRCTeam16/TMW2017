...
DriveBase::DriveBase() : Subsystem("DriveBase") {
    ...
    std::for_each(steering.begin(), steering.end(),
    	...
    	steer->ConfigNeutralMode(CANSpeedController::NeutralMode::kNeutralMode_Brake);
    });
...
void DriveBase::SetSteering(DriveInfo<double> setpoint) {
	if (driveFront) {
		...
		SetSteerSetpoint(setpoint.RL, rearLeftPos,
						...
						turns.RL, inv.RL);
		SetSteerSetpoint(setpoint.RR, frontRightPos,
						positionOffsets.RR, rearRight, rearLeftSteer,
						turns.RR, inv.RR);
	} else {
		...
		SetSteerSetpoint(setpoint.FR, rearLeftPos,
						positionOffsets.RL, rearLeft, rearLeftSteer,
						turns.RL, inv.RL);
		SetSteerSetpoint(setpoint.FL, frontRightPos,
						positionOffsets.RR, rearRight, rearLeftSteer,
						turns.RR, inv.RR);
	}
}
